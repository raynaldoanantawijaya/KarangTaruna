...
import { Trash2, Plus, Video, Loader2, Play } from 'lucide-react';
...
interface VideoItem {
    ...
    title: string;
    description: string;
    videoUrl: string; // URL to YouTube or uploaded file
...
function VideosPageContent() {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Check file size (e.g., limit to 50MB for videos)
        ...
        try {
            ...
            if (res.ok) {
                ...
                showToast('Video berhasil diunggah', 'success');
            } else {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/admin/videos', {
                ...
                body: JSON.stringify({ title, description, videoUrl, public_id: publicId, category }),
            });
            ...
            if (res.ok) {
                ...
                showToast('Gagal menambahkan video', 'error');
            }
        } catch (error) {
            console.error('Error adding item', error);
            showToast('Terjadi kesalahan saat menambah video', 'error');
        } finally {
            setIsSubmitting(false);
        }
    };
    ...
    const confirmDelete = async () => {
        ...
        try {
            const res = await fetch(`/api/admin/videos?id=${itemToDelete}`, {
                method: 'DELETE',
            });
            ...
            showToast('Terjadi kesalahan saat menghapus video', 'error');
        } finally {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="md:flex md:items-center md:justify-between mb-8">
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="mt-1 text-sm text-slate-500 dark:text-gray-400">Manage videos for the "Gallery" section.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 border border-gray-100 dark:border-gray-700 sticky top-24">
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Add New Video</h3>
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary focus:ring-primary sm:text-sm dark:bg-gray-700 dark:text-white p-2 border mb-2"
                                        ...
                                        <div className="relative flex py-2 items-center">
                                            ...
                                            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs">OR UPLOAD</span>
                                            <div className="flex-grow border-t border-gray-300 dark:border-gray-600"></div>
                                        </div>
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                <div className="space-y-1 text-center">
                                                    <Video className="mx-auto h-12 w-12 text-gray-400 group-hover:text-primary transition-colors" />
                                    ...
                                    >
                                        {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin flex-shrink-0" /> : <><Plus className="w-5 h-5 flex-shrink-0" /> <span>Add Video</span></>}
                                    </button>
                                </form>
                            </div>
                        </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden border border-gray-100 dark:border-gray-700">
                                {isLoading ? (
                                    ...
                                    <div className="p-8 text-center text-gray-500 flex flex-col items-center">
                                        ...
                                        <p>No videos found. Add one from the form.</p>
                                    </div>
                                ) : (
                                        ...
                                        {items.map((item) => (
                                            <li key={item.id} className="p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                                <div className="flex flex-col sm:flex-row gap-4">
                                                    <div className="flex-shrink-0 w-full sm:w-48 h-32 relative rounded-lg overflow-hidden bg-gray-900 border border-gray-200 dark:border-gray-600 group">
                                                        {/* Simple Video Preview or Icon */}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 sm:p-8 max-w-sm w-full transform transition-all">
                        <div className="mb-6 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 text-sm">
                                Apakah Anda yakin ingin menghapus video ini secara permanen? Aksi ini tidak dapat dibatalkan.
                            </p>
                        </div>
